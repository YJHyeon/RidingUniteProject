 ...
 * @author asde4
 */
public class GUI_AdminRideAir_Change extends javax.swing.JFrame {
    ...
    public GUI_AdminRideAir_Change(String id) {
        this.id = id;
        initComponents();
    }
     ...
     */
    public GUI_AdminRideAir_Change() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_AdminRideAir_Change.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUI_AdminRideAir_Change().setVisible(true);
            }
        });
    }
