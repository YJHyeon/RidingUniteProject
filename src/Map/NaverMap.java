...
public class NaverMap implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		String clientId = "spqj46fooe";
		String clientSecret = "KGqZPvNO8xc0DpbTjRNosSIccxvEKXKzH0YFWqfD";
		AddressVO vo = null;
	...
	public void map_service(AddressVO vo) {
		...
		try {
			...
			HttpURLConnection con = (HttpURLConnection) url.openConnection();
			con.setRequestMethod("GET");
			con.setRequestProperty("X-NCP-APIGW-API-KEY-ID", "spqj46fooe");
			con.setRequestProperty("X-NCP-APIGW-API-KEY", "KGqZPvNO8xc0DpbTjRNosSIccxvEKXKzH0YFWqfD");
